                ...
                <div class="card my-5">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <h4 class="f-w-500 mb-1">Đăng nhập tại đây</h4>
                            <p class="mb-3">Bạn chưa có tài khoản? <a href="@/pages/register-v1.html"
                                    class="link-primary ms-1">Đăng ký tài khoản</a></p>
                        </div>
                        ...
                        <div class="d-flex mt-1 justify-content-between align-items-center">
                            ...
                            <a href="../pages/forgot-password-v1.html">
                                <h6 class="f-w-400 mb-0">Quên mật khẩu?</h6>
                            </a>
                        </div>
